    ...
    */
    public function store(Request $request)
    {
        ...
        if($dataArr['image_url'] && $dataArr['image_name']){
            ...
            File::move(config('gtv.upload_path').$dataArr['image_url'], config('gtv.upload_path').$destionation);
    ...
    public function update(Request $request)
    {
        ...
        if($dataArr['unc_url'] && $dataArr['unc_name']){
            ...
            File::move(config('gtv.upload_path').$dataArr['unc_url'], config('gtv.upload_path').$destionation);
