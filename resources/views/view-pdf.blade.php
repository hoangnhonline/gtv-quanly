                ...
                <tr>
                    <td colspan="2">
                        ...
                        <div style="text-align: right; font-size: 12px; color: #5f6368;">
                         ...
                         <h4 class="text-center" style="color: #006dc2;clear: both;">XÁC NHẬN ĐẶT @if($detail->type == 1) TOUR @elseif($detail->type == 4) XE @elseif($detail->type == 5) LỊCH CHỤP ẢNH  @endif</h4>
                    </td>
                </tr>
                @else
                <tr>
                    <td colspan="2" class="text-center">
                        <img src="{{ asset('images/logo-group.jpg') }}" alt="logo" width="120px" />
                         <h4 class="text-center" style="color: #006dc2;clear: both;">XÁC NHẬN ĐẶT TOUR</h4>
                    </td>
                </tr>
                @endif
                <tr>
