    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">        
        <div class="panel-body">
          ...
          <form class="form-inline" role="form" method="GET" action="{{ route('booking-seasport.index') }}" id="searchForm">
             ...
             @if( $items->count() > 0 )
              ...
              @foreach( $items as $item )
                ...
                <span class="label label-sm label-danger" id="error_unc_{{ $item->booking_id }}"></span>       
                    ...
                    @endif
                    <br>
                        <a style="text-transform: uppercase;font-weight:bold;" href="{{ route( 'booking-seasport.edit', $arrEdit ) }}">
                       {{ $item->name }}</a>
