...
<section class="content-header">
  <h1 style="text-transform: uppercase;">
    Booking THỂ THAO BIỂN
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    <li><a href="{{ route( 'booking-seasport.index') }}">
    Danh sách
    </a></li>
...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      @endif
      @if($time_type == 3)
      <a href="{{ route('booking-seasport.create') }}?use_date={{ $arrSearch['use_date_from'] }}" class="btn btn-info btn-sm" style="margin-bottom:5px">Tạo mới</a>
      @else
      <a href="{{ route('booking-seasport.create') }}" class="btn btn-info btn-sm" style="margin-bottom:5px">Tạo mới</a>
      @endif

      <div class="panel panel-default">

        <div class="panel-body" style="padding: 5px !important;">
          <form class="form-inline" role="form" method="GET" action="{{ route('booking-seasport.index') }}" id="searchForm" style="margin-bottom: 0px;">

            <div class="form-group">
              <input type="text" class="form-control" autocomplete="off" name="id_search" placeholder="ID" value="{{ $arrSearch['id_search'] }}" style="width: 70px">
            </div>
            ...
            @if( $items->count() > 0 )
              ...
              <tr class="booking" id="row-{{ $item->booking_id }}" data-id="{{ $item->booking_id }}" data-date="{{ $item->use_date }}" style="border-bottom: 1px solid #000 !important;@if($item->status == 3) background-color: #f77e7e; @endif @if($item->da_thu == 0) background-color:#fcafa9 @endif ">
                ...
                <td class="text-right" style="white-space:nowrap">
                  ...
                  <a style="float:right; margin-left: 2px" href="{{ route( 'booking-seasport.edit', $arrEdit ) }}" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span></a>
                  <br>
    ...
    $(document).ready(function(){
      ...
      $('#btnExport').click(function(){
       ...
       $('.change-column-value').change(function(){
          ...
          $.ajax({
            url : "{{ route('booking-seasport.change-value-by-column') }}",
            type : 'GET',
            data : {
              id : obj.data('id'),
              col : obj.data('column'),
