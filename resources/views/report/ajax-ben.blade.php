       ...
       @if( $items->count() > 0 )
        ...
        @foreach( $items as $item )
         ...
         <li style="border-bottom: 1px solid #ddd; padding-bottom: 10px; padding-top: 10px; clear: both;font-size: 15px">                  
                    ...
                    @endif
                    <br>
                    <span style="color:#06b7a4; text-transform: uppercase;"><span style="color: #006dc2;font-weight: bold">PTT{{ $item->id }}</span> - {{ $item->name }} </span> 
                   @if($item->tour_id)
                  ...
                  @endif
                    ...
                    @if($item->notes)
                    <br>                    
                    <span style="color:#006dc2">{!! nl2br($item->notes) !!}</span>
                    @endif   
